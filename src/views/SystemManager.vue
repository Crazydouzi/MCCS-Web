          ...
          <v-col cols="12" lg="6" xl="6" md="6">
            <v-list density="compact">
              <v-list-item>
                ...
                <v-text-field label="端口号" variant="outlined" class="mt-2" density="compact" v-model="pageData.data.port"></v-text-field>
              </v-list-item>
              <v-list-item>
                <v-list-item-title>
                  <h4>字符编码</h4>
                ...
                <v-text-field label="编码" variant="outlined" class="mt-2" density="compact"  v-model="pageData.data.charset"></v-text-field>
              </v-list-item>
              <v-list-item>
                <v-list-item-title>
                  <h4>远程库配置</h4>
          ...
          <v-col>
            <v-list>
              <v-list-item>
                ...
                <v-text-field label="上传位置" variant="outlined" class="mt-2" density="compact"  v-model="pageData.data.fileOptions.dir"></v-text-field>
...
const pageData = reactive({ data: { "port": null, "charset": null, "fileOptions": {"dir":null,"deleteUploadedFilesOnEnd":false} } })
